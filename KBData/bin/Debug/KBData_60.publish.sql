...
BEGIN
	...
	SELECT Product.Id , ProductName, ProductQuantity, ProductPrice, ProductDescription, ProductID, ProductImageLocation, ProductImageName,
			(SELECT string_agg(ProductImage.ProductImageName,',') AS i
			FROM Product
			WHERE Product.Id IN
			(SELECT DISTINCT ProductImage.ProductId
					FROM ProductImage
