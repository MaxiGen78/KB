...
GO
PRINT N'Altering [dbo].[ProductImages]...';


GO
ALTER TABLE [dbo].[ProductImages] ALTER COLUMN [ProductID] INT NULL;
...
AS
BEGIN
	SELECT [Product].Id , ProductName, ProductQuantity, ProductPrice, ProductDescription, ProductID, ProductImageName, ProductImageLocation
	FROM [dbo].[Product]
	INNER JOIN [dbo].[ProductImages]
